...
function index(myVarVal) {
	...
	gradientStroke1.addColorStop(
		0,
		hexToRgba(myVarVal, 0.8) || "rgba(108, 95, 252, 0.8)"
	);
	gradientStroke1.addColorStop(
		1,
		hexToRgba(myVarVal, 0.2) || "rgba(108, 95, 252, 0.2) "
	);

	gradientStroke2 = myCanvasContext.createLinearGradient(0, 80, 0, 280);
	gradientStroke2.addColorStop(
		0,
		hexToRgba(myVarVal1, 0.8) || "rgba(5, 195, 251, 0.8)"
	);
	gradientStroke2.addColorStop(
		1,
		hexToRgba(myVarVal1, 0.8) || "rgba(5, 195, 251, 0.2) "
	);
