...
<head>
    ...
    <!-- 
    <link href="<?= base_url(); ?>/assets/plugins/multipleselect/_multiple-select.scss" rel="stylesheet"> -->
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/tables/themes/icon.css">
    ...
    function updateLiveAlert() {
        ...
        if (s == null) {
            addLocal('noliveshow', true);
        } else {
            deleteLocal('noliveshow');
        }
        location.reload();
    }
    ...
    <script>
    // it will be moved in main.js
    function show_live() {
        let v = sessionStorage.getItem("live_id");
        if (v == '') {
            v = $('#live_gm_title').text();
        } else {
            $('#gm_id').val(v);
        }
        location.replace('<?= base_url(); ?>home/live?gid=' + v);
    }
    </script>
</head>

<!--
<body class="app sidebar-mini ltr light-mode bg-img1 sidebar-gone">
 -->

<body class="app sidebar-mini ltr bg-img1 dark-mode">
    <!-- Live Toast-->
    <div class="position-fixed p-3 live_alert">
        <div class="toast show" id="live_alert" role="alert" aria-live="assertive" aria-atomic="true"
            data-bs-autohide="false">
            <div class="toast-header">
                <i class="ion-game-controller-b"></i>
                <strong class="me-auto">Live Game!</strong>
                <small>timer!</small>
                <button aria-label="Close" class="btn-close fs-20" data-bs-dismiss="toast" onClick="close_live();"><span
                        aria-hidden="true">×</span></button>
            </div>
            <div class="toast-body">
                <h6><span id="live_gm_title"></span></h6>
                This Game is n Live
                <div class="mt-2 pt-2 border-top">
                    <button type="button" class="btn btn-primary btn-sm" onClick="show_live();">Show Bets</button>
                    ...
                    <div class="predefined_styles">
                        <div class="swichermainleft text-center">
                            <div class="p-3 d-grid gap-2">
                                <a href="https://codeigniter.spruko.com/sash/" class="btn ripple btn-primary mt-0">View
                                    Demo</a>
                            ...
                            <div class="skin-body switch_section">
                                ...
                                <div class="switch-toggle d-flex mt-2">
                                    <a class="bg-img1" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="<?= base_url(); ?>assets/images/media/bg-img1.jpg" alt="Bg-Image"
                                            id="bgimage1"></a>
                                    <a class="bg-img2" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="<?= base_url(); ?>assets/images/media/bg-img2.jpg" alt="Bg-Image"
                                            id="bgimage2"></a>
                                    <a class="bg-img3" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="<?= base_url(); ?>assets/images/media/bg-img3.jpg" alt="Bg-Image"
                                            id="bgimage3"></a>
                                    <a class="bg-img4" href="javascript:void(0);" onclick="bgImage(this)"><img
                                            src="<?= base_url(); ?>assets/images/media/bg-img4.jpg" alt="Bg-Image"
                                            id="bgimage4"></a>
                                </div>
                            </div>
                        </div>
