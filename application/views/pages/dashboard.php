                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            ...
                                            <h2 class="mb-0 number-font">Calculating....</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6 col-xxl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            <h6 class="">Total Bets</h6>
                                            <h2 class="mb-0 number-font"><?= $totalBetAmount; ?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-body">
                <ul class="row p-3">
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                    src="<?= base_url(); ?>assets/images/flags/malaysia.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                    src="<?= base_url(); ?>assets/images/flags/turkey.jpg"
